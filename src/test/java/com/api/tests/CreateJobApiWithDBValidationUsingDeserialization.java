...
public class CreateJobApiWithDBValidationUsingDeserialization {
...

	{
		...
		customerProduct = new CustomerProduct(timeWithDaysAgo(10), "19389159131418", "19389159131418", "19389159131418",timeWithDaysAgo(10), Products.NEXUS_2.getCode(), Models.NEXUS_2_BLUE.getCode());
