...
public class CreateJobApiWithDBValidationUsingDeserialization {
...

	{
		...
		customerAddress = new CustomerAddress("123", "Galaxy", "Khao Gali", "Opposite RBI", "Navi Mumbai", "122022",
				"India", "Haryana");
		customerProduct = new CustomerProduct(timeWithDaysAgo(10), "19389182231418", "19389182231418", "19389182231418",
	...
	public void createJobAPITest() {
		...
		AssertionUtility.assertProblemDetails(problemsList, problemDataFromDB);
